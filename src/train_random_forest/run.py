...
def go(args):
    ...
    run = wandb.init(project="nyc_airbnb", group="development", save_code=True)
    trainval_local_path = wandb.use_artifact("clean_sample.csv:latest").file()
    ######################################
    ...
    logger.info("Creating an artifact in wandb")
    ...
    logger.info("Adding directory to the artifact")
    artifact.add_dir("random_forest_dir")

    logger.info("Logging artifact to the run")
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    sk_pipe = Pipeline([('preprocessor', preprocessor),
                        ('random_forest', random_Forest)])# YOUR CODE HERE
